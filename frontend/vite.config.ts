...
export default defineConfig(({ mode }) => {
  ...
  const buildCSP = () => {
    ...
    csp += ` script-src 'self' 'unsafe-inline'${isDev ? ' \'unsafe-eval\'' : ''} https://challenges.cloudflare.com https://static.cloudflareinsights.com https://www.googletagmanager.com https://www.google-analytics.com;`;
