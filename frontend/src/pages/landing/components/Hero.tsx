...
export function Hero() {
  return (
    <section className="relative pt-32 sm:pt-48 pb-20 sm:pb-32 px-6 overflow-hidden bg-brand-warm">
      ...
      <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] rounded-full bg-blue-electric/10 blur-[120px] pointer-events-none animate-pulse" style={{ animationDuration: '12s' }}></div>
