...
import { TrendingUp, MessageSquare, Target, PenTool, BarChart3, Sparkles } from 'lucide-react';
...
const EmptyState = ({ onSuggestionClick }: EmptyStateProps) => {
  return (
    <div className="h-full flex flex-col items-center justify-center max-w-2xl mx-auto text-center px-4 py-8">
      {/* Logo / Brand */}
      <div className="mb-8">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white mb-4 mx-auto shadow-lg shadow-blue-600/20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-xl">
        {suggestions.map((suggestion, idx) => (
          <button
            ...
            className="group flex items-center gap-3 p-4 bg-white border border-slate-200 rounded-xl text-left hover:border-slate-300 hover:shadow-md transition-all duration-200"
          >
            <Sparkles size={16} className="text-slate-300 group-hover:text-blue-500 transition-colors flex-shrink-0" />
