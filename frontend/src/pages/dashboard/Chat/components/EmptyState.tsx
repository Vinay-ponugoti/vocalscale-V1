 ...
 * Clean ChatGPT-style welcome screen
 */
...
const EmptyState = ({ onSuggestionClick }: EmptyStateProps) => {
  return (
    <div className="h-full flex flex-col items-center justify-center max-w-2xl mx-auto text-center px-4 py-8 bg-white">
      {/* Welcome message */}
        ...
        {suggestions.map((suggestion, idx) => (
          <button
            ...
            className={cn(
              ...
              "bg-white border border-gray-200 rounded-xl text-left",
