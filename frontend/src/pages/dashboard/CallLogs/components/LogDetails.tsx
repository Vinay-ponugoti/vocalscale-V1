                 ...
                 transcriptMessages.map((msg) => {
                   ...
                   return (
                    <div key={msg.id} className={`flex gap-3 ${isAI ? '' : 'flex-row-reverse'}`}>
                       <div className={`h-8 w-8 rounded-xl flex items-center justify-center shrink-0 border text-[10px] font-black shadow-sm ring-1 ${
                         isAI ? 'bg-indigo-600 border-indigo-500 text-white ring-indigo-500/20' : 'bg-white border-slate-200 text-slate-600 ring-slate-900/5'
                       }`}>
                       ...
                       <div className={`space-y-1 max-w-[85%] ${isAI ? '' : 'flex flex-col items-end'}`}>
                         <div className={`px-4 py-3 text-[13px] leading-relaxed transition-all font-medium ${
                           isAI 
            ...
            <Card className="bg-white rounded-xl border-slate-200 shadow-sm overflow-hidden ring-1 ring-slate-200/50">
                ...
                <CardContent className="p-5 space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <Badge className={`text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-lg border shadow-none ${
