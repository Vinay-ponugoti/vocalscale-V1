            ...
            <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5`}>
                {numbers.map((item) => {
                    ...
                    <div 
                        ...
                        className={`group relative flex flex-col rounded-2xl ${isMobile ? 'p-5' : 'p-6'} cursor-pointer transition-all border-2 ${
                        isSelected 
                    ...
                    >
                        <div className={`absolute top-4 right-4 ${isMobile ? 'w-5 h-5' : 'w-6 h-6'} rounded-full flex items-center justify-center transition-all ${
                        isSelected 
                        ...
                        <span className={`text-[9px] md:text-[10px] font-black uppercase tracking-widest mb-1.5 ${
                            isSelected ? 'text-indigo-600' : 'text-slate-400'
                        }`}>
                            {item.badge || (isSelected ? 'Selected' : 'Standard')}
                        </span>
                        <h4 className={`text-xl md:text-2xl font-black tracking-tighter font-mono ${
