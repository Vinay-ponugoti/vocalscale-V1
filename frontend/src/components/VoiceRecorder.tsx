...
export const VoiceRecorder: React.FC<VoiceRecorderProps> = ({
  ...
  }, [analyzeAudioLevels, assessQuality, duration, onRecordingComplete, quality]);
  ...
  }, [externalIsRecording, isRecording, startRecording, stopRecording]);
  ...
  const getQualityColor = () => {
    if (!quality) return 'text-charcoal-light';
    switch (quality.level) {
      case 'excellent': return 'text-green-500';
      case 'good': return 'text-blue-electric';
    ...
    <div className={`voice-recorder ${className}`}>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-charcoal-medium">
        ...
        {isRecording && (
          <div className="mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-charcoal-medium w-12">
      ...
      {isRecording && (
        <div className="flex justify-center space-x-4 mt-4">
          <button
            ...
            className="px-4 py-2 text-sm bg-charcoal-medium text-white rounded-lg hover:bg-charcoal transition-colors"
          >
      ...
      {permissionStatus === 'denied' && (
        <div className="mt-4 text-center text-sm text-charcoal-medium">
