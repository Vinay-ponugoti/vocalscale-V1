  ...
  return (
    <DashboardLayout fullWidth secondaryNav={filtersNav}>
      <div className="bg-white h-full flex flex-col overflow-hidden">
        ...
        {/* --- Stats Summary Bar --- */}
        <div className="bg-white border-b border-slate-100 px-8 py-5 flex items-center gap-10 shrink-0 overflow-x-auto no-scrollbar">
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className={`text-[11px] font-black px-2 py-0.5 rounded-lg ring-1 ${
                  stats.callsTrendUp 
