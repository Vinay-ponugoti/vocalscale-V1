                ...
                <div className="flex flex-col justify-between gap-8">
                    ...
                    <div className="relative bg-slate-50 rounded-3xl border border-slate-100 p-8 overflow-hidden">
                        ...
                        <div className="flex justify-between items-center relative z-10">
                            ...
                            <div className="flex flex-col items-center gap-3">
                                <div className="w-20 h-20 rounded-full bg-indigo-600 shadow-xl shadow-indigo-500/30 flex items-center justify-center text-white relative z-10 border-4 border-white">
                                    <Bot className="w-8 h-8" strokeWidth={2.5} />
                                    <div className="absolute top-0 right-0 w-5 h-5 bg-emerald-500 border-2 border-white rounded-full animate-pulse"></div>
                                </div>
                                <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600">AI Receptionist</span>
                            </div>
                        </div>
                    </div>

                    {/* Test Action */}
                    <div className="bg-indigo-50 border border-indigo-100 rounded-3xl p-6 text-slate-900 shadow-sm flex flex-col gap-5 relative overflow-hidden group">
                        {/* Glow effect */}
                        ...
                        <div className="flex items-center gap-4 relative z-10">
                            <div className="h-12 w-12 rounded-xl bg-white border border-indigo-100 flex items-center justify-center shadow-sm">
                                <Activity className="w-6 h-6 text-indigo-600" />
                            </div>
                            <div>
                                <h3 className="text-lg font-black tracking-tight">Verify Connection</h3>
                                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Ensure calls are routed correctly</p>
                            </div>
                        </div>
                        <button className="w-full h-12 bg-indigo-600 text-white hover:bg-indigo-700 rounded-xl font-black uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-2 group-hover:scale-[1.02] active:scale-95 shadow-lg shadow-indigo-600/20">
