...
Then update the READMEmd, make sure you include an index of all documentation created in agent, so anyone can just look at README.md to get full understanding of where to look for what information
